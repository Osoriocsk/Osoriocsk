...
| **RoboEvita 1.0** | Autonomous obstacle-avoidance robot built with ultrasonic sensing and motor control. | Arduino, HC-SR04, L298N | https://github.com/Osoriocsk/robot |
...
| **RoboEvita 1.0** | Robot autónomo evasor de obstáculos con sensado ultrasónico y control de motores. | Arduino, HC-SR04, L298N | https://github.com/Osoriocsk/robot |
...
> Más repos fijados (pinned) abajo 👇
...
<div align="center">
  <sub>Built with ☕ and a lot of debugging — Bucaramanga, Colombia 🇨🇴</sub>
</div>
